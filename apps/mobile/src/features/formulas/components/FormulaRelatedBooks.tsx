...
import { FormulaBookReference } from '../types/formula.types';

export function FormulaRelatedBooks({
  bookReferences,
}: {
  ...
  return (
    <Section className="mb-4">
      <SectionHeader
        title="Read in Textbooks"
        subtitle="Direct NCTB book references and exact page locations"
      />
